...
export const PoliticaPrivacidad = () => {
  return (
    <div>
      ...
      <p>
        El presente Política de Privacidad APOD establece los términos en que
        usa y protege la información que es proporcionada por sus usuarios al
        momento de utilizar su sitio web y aplicación móvil. Esta compañía está
        ...
        pedido o realizar una entrega o facturación. <br />
        ...
        mejorar nuestros productos y servicios. <br /> <br /> Es posible que
        sean enviados correos electrónicos periódicamente a través de nuestro
        ...
        algún beneficio, estos correos electrónicos serán enviados a la
        dirección que usted proporcione y podrán ser cancelados en cualquier
        momento. está altamente comprometido para cumplir con el compromiso de
        ...
        proporcione directamente noticias. <br /> <br />
        ...
        pueda utilizar algunos de nuestros servicios. Enlaces a Terceros Este
        ...
        requerido por un juez con un orden judicial. Se reserva el derecho de
        cambiar los términos de la presente Política de Privacidad en cualquier
        momento.
      </p>
    </div>
  )
